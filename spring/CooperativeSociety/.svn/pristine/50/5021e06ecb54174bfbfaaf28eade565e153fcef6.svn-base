...
public class UserProfile {
	...
	private List<SecurityQnA> securityQnAList;
	private String errorMsg;
	private boolean isUserReAuthenticated;
	...
	public List<SecurityQnA> getSecurityQnAList() {
		return securityQnAList;
	}
	public void setSecurityQnAList(List<SecurityQnA> securityQnAList) {
		this.securityQnAList = securityQnAList;
	}
	...
	public boolean isUserReAuthenticated() {
		return isUserReAuthenticated;
	}
	public void setUserReAuthenticated(boolean isUserReAuthenticated) {
		this.isUserReAuthenticated = isUserReAuthenticated;
	}
