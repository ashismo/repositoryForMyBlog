...
<body>
			<fieldset>
			<input class="submit" type="button" value="Add new env" id="newModuleEnv"> </p>
			
			<div>
			<table id="moduleEnvDataTable" class="display cell-border" cellspacing="0" width="100%">
				<thead>
		            <tr>
		            	<th>URL Id</th>
		            	<th>Name</th>
			...
			<div id="addModifyModuleEnv" style="display:none;" title="Add/Modify URL">
					...
					<tbody>
						<tr>
							<td>
								...
								<p><input name="urlName" type="text" value="" required/></p>
							</td>
							<td>
						...
						<tr>
							<td>
								...
								<p><input name="urlDesc" type="text" value="" required/></p>	
							</td>
							<td>
						...
						<tr>
							<td>
								...
								<p><input name="url" type="text" value="" required/></p>
							</td>
							<td>
						...
						<tr>
							...
							<td>
								<h4><strong>Visible to All</strong></h4>
								<p>
