...
public class LedgerCodeRetailCC extends DozerConverter<RetailLedgerCodeBean, LedgerCodeRetail> implements MapperAware, CustomConverter {
	@Autowired
	...
	public LedgerCodeRetailCC() {
		super(RetailLedgerCodeBean.class, LedgerCodeRetail.class);
	}
	...
	@Override
	public RetailLedgerCodeBean convertFrom(LedgerCodeRetail src, RetailLedgerCodeBean dest) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public LedgerCodeRetail convertTo(RetailLedgerCodeBean src, LedgerCodeRetail dest) {
		// TODO Auto-generated method stub
		if(src != null) {
