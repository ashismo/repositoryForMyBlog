...
@Component("modeOfPaymentCC")
public class ModeOfPaymentCC extends DozerConverter<Object, TransactionPayment> implements MapperAware, CustomConverter {
	@Autowired
	...
	public ModeOfPaymentCC() {
		super(Object.class, TransactionPayment.class);
	}
	
	public ModeOfPaymentCC(Class prototypeA, Class prototypeB) {
