 ...
 */
@Entity
@Table(name="ledger_code_retail_purchase")
@NamedQuery(name="LedgerCodeRetailPurchase.findAll", query="SELECT l FROM LedgerCodeRetailPurchase l")
@SQLDelete(sql="update ledger_code_retail_purchase set delete_ind='Y' where retail_ledger_code_id = ?")
@Where(clause="delete_ind is NULL")
public class LedgerCodeRetailPurchase implements Serializable {
	...
	public LedgerCodeRetailPurchase() {
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LedgerCodeRetailPurchase other = (LedgerCodeRetailPurchase) obj;
