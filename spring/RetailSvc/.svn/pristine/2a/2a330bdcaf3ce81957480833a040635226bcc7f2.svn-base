...
public class RetailBusinessConstants {
	...
	public static String ENTRY_TYPE_PURCHASE 			= "PURCHASED";
	public static String ENTRY_TYPE_YR_CLOSE_OPENING 	= "YR_CLOSE_OPENING";
	public static String ENTRY_TYPE_OPENING				= "OPENING";
	public static String ENTRY_TYPE_PURCHASE_RETURN	 	= "PURCHASE_RETURN";
	public static String ENTRY_TYPE_ENTRY_RETURN		= "ENTRY_RETURN";
