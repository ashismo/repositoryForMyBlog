...
@Component("retailAddressCC")
public class RetailAddressCC extends DozerConverter<Integer, DistrictMaster> implements MapperAware, CustomConverter {
	@Autowired
	private DistrictMasterRepository districtMasterRepository;
	
	public RetailAddressCC() {
		super(Integer.class, DistrictMaster.class);
	}
	
	public RetailAddressCC(Class prototypeA, Class prototypeB) {
