...
INSERT INTO `branch_master` (`branch_id`, `parent_id`, `bank_name`, `branch_name`, `ifsc_code`, `micr_code`, `db_name`, `context_root`, `email1`, `email2`, `phone1`, `phone2`, `remarks`, `start_date`, `end_date`, `delete_ind`, `create_user`, `create_date`, `update_user`, `update_date`) VALUES
	(2, 0, 'Janai', 'Janai', '12345678', '87654321', 'coop_janai', 'CustomerSvcWS', 'ashismo@gmail.com', NULL, '9830625559', NULL, NULL, '2015-12-18', NULL, NULL, 'ashish', '2016-03-15 21:33:19', NULL, '2016-03-15 21:33:19');
...
-- Dumping data for table retail_unittest.material_group: ~0 rows (approximately)
...
-- Dumping data for table retail_unittest.material_master: ~0 rows (approximately)
...
-- Dumping data for table retail_unittest.retail_customer_master: ~0 rows (approximately)
...
-- Dumping data for table retail_unittest.retail_rate_chart: ~0 rows (approximately)
...
-- Dumping data for table retail_unittest.stock_entry: ~0 rows (approximately)
...
-- Dumping data for table retail_unittest.vat_reg_no: ~0 rows (approximately)
...
-- Dumping data for table retail_unittest.vendor_master: ~0 rows (approximately)
