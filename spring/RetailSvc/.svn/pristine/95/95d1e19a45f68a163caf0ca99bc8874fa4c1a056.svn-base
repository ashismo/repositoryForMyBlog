...
/**
 * The persistent class for the credit_register database table.
 * 
 */
@Entity
@Table(name="credit_register")
@NamedQuery(name="CreditRegister.findAll", query="SELECT c FROM CreditRegister c")
@SQLDelete(sql="update credit_register set delete_ind='Y' where credit_id = ?")
...
public class CreditRegister implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CreditRegister other = (CreditRegister) obj;
