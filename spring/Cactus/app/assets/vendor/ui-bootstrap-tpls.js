...
.directive('uibAccordionGroup', function() {
  return {
    ...
    scope: {
      ...
      crud: '=crud',               // Interpolate the heading attribute onto this scope
...
angular.module("uib/template/accordion/accordion-group.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("uib/template/accordion/accordion-group.html",
    ...
    "  <div role=\"tab\" id=\"{{::headingId}}\" aria-selected=\"{{isOpen}}\" class=\"panel-heading crud-wrapper\" ng-keypress=\"toggleOpen($event)\">\n" +
    "    <h4 class=\"panel-title crud-head\">\n" +
    "      <a role=\"button\" data-toggle=\"collapse\" href aria-expanded=\"{{isOpen}}\" aria-controls=\"{{::panelId}}\" tabindex=\"0\" class=\"accordion-toggle\" ng-click=\"toggleOpen()\" uib-accordion-transclude=\"heading\"><span uib-accordion-header ng-class=\"{'text-muted': isDisabled}\">{{heading}}</span></a>\n" +
    "    </h4><div class=\"crud\"><span ng-repeat='crud in crud | orderBy:\"permission\"'><input type='checkbox' ng-disabled='crud.disabled' ng-click='addAvalModulePermission(crud.permission,crud)' ng-model=\"crud.permission\" ng-true-value=\"'{{crud.permission}}'\" ng-false-value=\"'{{crud.permission}}'\" ng-checked=\"crud.checked\"><label>{{crud.permission}}</label></span>\n" +
    "  </div>\n" +
