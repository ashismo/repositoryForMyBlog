...
-- Dumping data for table coopadmin.address: ~9 rows (approximately)
...
-- Dumping data for table coopadmin.branch_address: ~9 rows (approximately)
...
-- Dumping data for table coopadmin.branch_rule: ~9 rows (approximately)
...
-- Dumping data for table coopadmin.module_master: ~6 rows (approximately)
...
-- Dumping data for table coopadmin.permission_master: ~17 rows (approximately)
...
-- Dumping data for table coopadmin.role_master: ~7 rows (approximately)
...
-- Dumping data for table coopadmin.role_permission: ~15 rows (approximately)
...
-- Dumping data for table coopadmin.rule_master: ~7 rows (approximately)
...
-- Dumping data for table coopadmin.rule_master_values: ~5 rows (approximately)
...
-- Dumping data for table coopadmin.user: ~14 rows (approximately)
...
-- Dumping data for table coopadmin.user_credential: ~10 rows (approximately)
...
INSERT INTO `user_credential` (`user_id`, `password`, `transaction_pwd`, `last_login`, `last_unsuccessful_login`, `unsuccessful_login_count`, `successful_login`, `delete_ind`, `create_user`, `create_date`, `update_user`, `update_date`) VALUES
	(1, '$2a$10$ZegdnnlLZQK62HAeBPjJee20AKlvVPMB2WiCkFr7L/k8c0QjvpE5e', '$2a$10$ZegdnnlLZQK62HAeBPjJee20AKlvVPMB2WiCkFr7L/k8c0QjvpE5e', NULL, NULL, 0, 0, '0', 'ashish', '2016-06-01 01:14:17', NULL, '2016-06-01 01:14:36');
...
-- Dumping data for table coopadmin.user_role: ~13 rows (approximately)
