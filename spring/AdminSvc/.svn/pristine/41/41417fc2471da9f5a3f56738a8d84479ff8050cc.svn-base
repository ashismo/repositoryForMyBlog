...
public class TestCoOperativeAdminDBConfig {
	...
	@Value("classpath:testdb/coopadmin_data.sql")
	private Resource dataScript;
	
	@Value("classpath:testdb/coopadmin_schema.sql")
...
//		properties.setProperty("hibernate.connection.url", "jdbc:h2:~/h2-testdb;INIT=CREATE SCHEMA IF NOT EXISTS coopadmin");
