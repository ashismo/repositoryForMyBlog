...
public class LoggingAspect {
	@Before("execution(* com.ashish.learning.v4.aop.SpringAOPServices.aMethod(..))")
	...
	@After("execution(* com.ashish.learning.v4.aop.SpringAOPServices.aMethod(..))")
	public void afterExecution(JoinPoint jp) {
		System.out.println("After method: " + jp.getSignature().getName()
				+ ". Class: " + jp.getTarget().getClass().getSimpleName());
	}
	
	@AfterReturning(pointcut = "execution(* com.ashish.learning.v4.aop.SpringAOPServices.returningAdvice(..))", returning = "result")
	...
	@AfterThrowing(pointcut = "execution(* com.ashish.learning.v4.aop.SpringAOPServices.throwsAdvice(..))", throwing = "ex")
	...
	@Around("execution(* com.ashish.learning.v4.aop.SpringAOPServices.testAround*(..))")
