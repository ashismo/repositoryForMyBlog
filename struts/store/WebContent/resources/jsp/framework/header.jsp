...
<%
	...
	if(userBean != null && userBean.getShopName() != null) {
		shopName = userBean.getShopName();
	}
...
<div id="page-top">
	...
	<div style="font-size: 40px;line-height: 44px; color: RED; font-family: sans-serif; padding-left: 450px;" >
		<%=shopName%>
	</div>
	<div style="font-size: 15px;line-height: 20px; color: WHITE; font-family: sans-serif; padding-left: 350px;" >
		Welcome <%=userName%>
	</div>
	<!-- end logo -->
