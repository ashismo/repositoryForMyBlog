...
Welcome Guest.
<form id="testAjax">
	<input type="text" value="Test Ajax" name="inputText"></input>
	<input type="button" value="Test Ajax" class="testAjax"></input>
	<input type="button" value="Data Table From array -> expandable columns" class="testAjaxFromXML"></input>
	<br>
	<input type="button" value="Data Table From Xml" class="dataTableFromXML"></input>
</form>
<a href="javascript:void(0)" id="delete">Delete selected row</a>
<div id="dataTable">
	
</div>
<div id="dataTableFromXml">
	
</div>

<div id='jqxWidget' style="font-size: 13px; font-family: Verdana; float: left;width: 820">
	<div id="jqxgrid">
	</div>
	...
	<td>
		...
		<td class="noheight">
			...
			<tr  valign="top">
				...
				<td><a href=""  id="date-pick"><img src="<%=request.getContextPath()%>/resources/js/dashboard/images/forms/icon_calendar.jpg"   alt="" /></a></td>
			</tr>
			</table>
